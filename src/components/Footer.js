...
const Footer = () => {
    return (
        <MDBFooter color="brown" className="text-center font-small darken-2">
            <div className="pt-4">
            ...
            <p className="footer-copyright mb-0 py-3 text-center">
                &copy; {new Date().getFullYear()} Copyright: <a href="https://www.MDBootstrap.com"> Cash And Carry Store </a>
            </p>
        </MDBFooter>
    );
}
